...
public class RebtelWebTests extends TestBase {
	...
	// Setting parameterized test to test the entire flow with different currency values.
	...
	public void testUnlimitedPurchaseFlow() {
		...
		// STEP 5: Now the user should be redirected to the checkout page, asking to signup/login
		assertTrue(driver.getTitle().contains("Sign up or Login"));
		
		// STEP 6: Check if the price in the order basket is correct in relation with the one presented on the 3 step (rate search).
		...
		/* STEP 8: Check again if the price is still the same, given that now you are logged in. 
		 * We have different prices for new users and paying users */
	...
	public String getPriceInCart() {
		...
		// Get amount value without the currency code and return. Eg. $25 will return 25.
